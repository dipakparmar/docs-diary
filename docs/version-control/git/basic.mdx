...
<Tabs groupId="operating-systems">
  <TabItem value="win" label="Windows">
    Download from <a href="https://git-scm.com/download/win">git-scm</a> and
    Install.
  </TabItem>
...
To install GitHub CLI, visit the official website: [https://cli.github.com/](https://cli.github.com/)
